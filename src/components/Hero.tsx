    ...
    >
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 pt-24 pb-20 text-center">
        ...
        <motion.h1
          ...
          className="font-display font-black text-white text-[clamp(1.75rem,8vw,2.5rem)] sm:text-5xl md:text-6xl lg:text-7xl leading-[1.1] sm:leading-[1.05] max-w-[19ch] sm:max-w-3xl md:max-w-4xl lg:max-w-5xl mx-auto break-words hyphens-auto [text-wrap:balance]"
        >
